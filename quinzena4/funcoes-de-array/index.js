...
function validarDescricao(texto){
    if(texto.value.replace(/ /g,"").length !== 0){  /* replace, substitui os espaços por  "", e verifica se o tamanho é diferente de 0.*/
        return true
    }
    return false
}
...
/* O método replace() retorna uma nova string com algumas ou todas as correspondências de um padrão substituídas por 
